...
let AdministratorService = class AdministratorService {
    ...
    async findOneByEmail(email) {
        return await this.administratorRepository.findOne({ where: { email } });
    }
    async findOneById(id) {
        return await this.administratorRepository.findOne({ where: { id } });
    }
    async findOneByVorname(vorname) {
        return await this.administratorRepository.findOne({ where: { vorname } });
    }
};
